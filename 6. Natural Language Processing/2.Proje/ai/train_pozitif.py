...
# Yalnızca pozitif (olumlu) yorumları ayıkla
dataset_pozitif = dataset.loc[dataset['Duygu'] == 1]

# pozitif yorumları tek bir metin (string) içerisinde topla.
rawData = ""
...
tf.saved_model.save(uretici_model, 'egitilmis_model_pozitif')
